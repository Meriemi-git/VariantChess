...
public class ChessPieceModel extends ChessModel {
    ...
    public ChessPieceModel(Model model, Location location, Material originalMaterial, GameElement gameElement) {
        super(model, location, originalMaterial, gameElement);
    }
